...
- **PFR-001**: Feature MUST achieve Lighthouse score 95+ across all metrics
- **PFR-002**: Core Web Vitals MUST meet: LCP < 1.2s, FID < 100ms, CLS < 0.1
- **PFR-003**: Images MUST use Next.js Image component with proper optimization
- **PFR-004**: Bundle size impact MUST be documented and justified if >10KB
  increase
- **PFR-005**: JavaScript execution time MUST stay under 100ms for main thread
  blocking
