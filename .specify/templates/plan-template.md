...
- [ ] Feature achieves Lighthouse 95+ target
- [ ] Core Web Vitals within limits (LCP < 1.2s, FID < 100ms, CLS < 0.1)
...
- [ ] Only approved dependencies used (Next.js 15, TypeScript, Tailwind CSS 4,
