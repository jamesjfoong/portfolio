...
const personalData: PersonalData = {
  ...
  experiences: [
    ...
    },
    {
      ...
      endDate: "2024-01",
      current: false,
      description: "Develop high-quality websites, design systems, and digital experiences for various clients.",
      achievements: [
    ...
    },
    {
      ...
      endDate: "2021-12",
      current: false,
      description: "Developed an internal employee time tracker and streamlined the payroll process.",
      achievements: [
  ...
  projects: [
    {
      ...
      shortDescription: "An AI-powered GitHub automation tool with 8 specialized tools for PR review workflows.",
      fullDescription:
    ...
    },
    {
      ...
      shortDescription: "A modern cryptocurrency landing page clone built with Next.js and Web3 integration.",
      fullDescription:
    ...
    },
    {
      ...
      slug: "jojobug-blog",
      title: "Jojobug Blog",
      shortDescription: "A modern blog platform with CMS integration and responsive design.",
      fullDescription:
      ...
      challenges: ["Building scalable CMS architecture", "Implementing efficient search", "Optimizing for SEO"],
      solutions: [
    ...
    },
    {
      ...
      slug: "vinobuah",
      title: "Vinobuah",
      shortDescription: "E-commerce landing page for a fruit selling website with modern design and responsive layout.",
      fullDescription:
    ...
    },
    {
      ...
      shortDescription: "Internal employee time tracker and payroll management system.",
      fullDescription:
      ...
      challenges: ["Complex payroll calculations", "Data security requirements", "User-friendly interface design"],
      solutions: [
    ...
    },
    {
      ...
      shortDescription: "Web-based book management system for university practicum activities.",
      fullDescription:
    ...
    },
    {
      ...
      shortDescription: "RESTful API service providing nutritional information about various foods.",
      fullDescription:
      ...
      challenges: ["Large nutritional database management", "API performance optimization", "Data accuracy validation"],
      solutions: [
    ...
    },
    {
      ...
      shortDescription: "Social media platform clone with React frontend and Node.js backend.",
      fullDescription:
      ...
      challenges: ["Real-time updates implementation", "Scalable database design", "User authentication system"],
      solutions: [
    ...
    },
    {
      ...
      solutions: ["Systematic learning approach", "Modular development practices", "Effective time management"],
      media: {
        type: MediaType.IMAGE_GALLERY,
      ...
      links: {
        case_study: "https://drive.google.com/file/d/19SsBkSgDshBSC6nwIlBSYrqj_hscMg9w/view",
      },
      metrics: {
