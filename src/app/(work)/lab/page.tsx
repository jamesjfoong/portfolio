...
const experiments = [
  {
    ...
    description: "An experimental AI-powered code completion and suggestion tool built with OpenAI API.",
    status: "In Progress",
  ...
  },
  {
    ...
    description: "A collaborative drawing canvas with real-time synchronization using WebSockets.",
    status: "Prototype",
  ...
  },
  {
    ...
    description: "Real-time web performance monitoring with custom metrics and visualizations.",
    status: "Concept",
      ...
      <motion.div variants={staggerContainer} initial="initial" animate="animate" className="space-y-12">
        ...
        <motion.div variants={staggerItem} className="text-center space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Experimental projects, prototypes, and innovative ideas. This is where I explore new technologies and push
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div className={`p-3 rounded-lg bg-secondary/20 ${experiment.color}`}>
                      <IconComponent className="w-6 h-6" />
                    </div>
                    <Badge variant={experiment.status === "In Progress" ? "default" : "secondary"} className="text-xs">
                      {experiment.status}
                    </Badge>
                  </div>
                  ...
                  <p className="text-muted-foreground text-sm mb-4 leading-relaxed">{experiment.description}</p>
        ...
        <motion.div variants={staggerItem} className="text-center py-12 bg-secondary/5 rounded-lg">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            I&apos;m always experimenting with new technologies and ideas. If you have an interesting concept or want to
            collaborate on something innovative, let&apos;s discuss it!
          </p>
        ...
        <motion.div variants={staggerItem} className="space-y-6">
          <h2 className="text-2xl font-semibold text-center">Technologies I&apos;m Exploring</h2>
