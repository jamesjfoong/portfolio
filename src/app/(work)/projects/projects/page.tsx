    ...
    <div className="mx-auto min-h-screen max-w-(--breakpoint-xl) px-6 py-12 font-sans md:px-12 md:py-20 lg:px-24 lg:py-0">
      <div className="lg:flex lg:justify-between lg:gap-4">
        <main className="pt-24 lg:py-24">
          ...
          <section>
            <h1 className="text-3xl font-bold tracking-tight text-slate-200 sm:text-4xl">All Projects</h1>
          </section>
            ...
            <table className="mt-12 w-full border-collapse text-left">
              <thead className="sticky top-0 z-10 border-b border-slate-300/10 bg-slate-900/75 px-6 py-5 backdrop-blur-sm">
                <tr>
                  ...
                  <th className="py-4 pr-8 text-sm font-semibold text-slate-200">Tech Stacks</th>
              ...
              <tbody>
                {projects.map(project => (
                  <tr key={project.id} className="border-b border-slate-300/10 last:border-none">
                    ...
                    <td className="py-4 pr-4 align-top font-semibold leading-snug text-slate-200">{project.title}</td>
                    <td className="py-4 pr-4 align-top text-sm">
                      <Image
                        src={project.media.thumbnail || project.media.gallery?.[0] || "/projects/otherprojects.png"}
                        alt={project.title}
                        width={100}
                        height={100}
                      />
                    ...
                    <td className="py-4 pr-4 align-top text-sm">
                      ...
                      >
                        {project.links.live || project.links.github || "No Link"}
                      </Link>
                    </td>
                  </tr>
                ))}
